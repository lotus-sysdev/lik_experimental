...
AUTHENTICATION_BACKENDS = [
    'page1.authentication.EmailBackend',
    'django.contrib.auth.backends.ModelBackend',
]

AUTH_USER_MODELS = 'page1.User'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to Lotus Admin",

    # Copyright on the footer
    "copyright": "Lotus Group",
    ...
    "order_with_respect_to": ["auth", "page1.customer", "page1.supplier", 'page1.employee', 'page1.prospect', 'page1.prospectlog', "page1.items", "page1.itemsumber", "page1.category", "page1.customeralamat", "page1.supplieralamat", 'page1.employeealamat', "page1.deliveryaddresses", "page1.prospectaddress", 'page1.provinsi', 'page1.kota', 'page1.kecamatan', 'page1.kelurahan', 'page1.kodepos', "page1.customerpic", "page1.supplierpic", 'page1.prospectpic', "page1.events", "page1.purchaseorder", "page1.workorder", "page1.messenger", "page1.vehicle", "page1.logbook", 'page1.itemchangelog', "page1.useractionlog"],
...
ADMIN_REORDER = (
    ...
    # {'app': 'page1', 'label':'Log Book', 'models': ('page1.logbook',)},
    # {'app': 'page1', 'label':'Admin', 'models': ('page1.useractionlogs',)},
