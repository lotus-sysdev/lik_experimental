...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('revenue_WO_currency', djmoney.models.fields.CurrencyField(choices=[('CNY', 'Chinese Yuan (CNY)'), ('IDR', 'Indonesian Rupiah (IDR)'), ('TWD', 'New Taiwan Dollar (TWD)'), ('SGD', 'Singapore Dollar (SGD)'), ('USD', 'US Dollar (USD)')], default='IDR', editable=False, max_length=3, null=True)),
                ('revenue_WO', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default_currency='IDR', max_digits=15, null=True, validators=[djmoney.models.validators.MinMoneyValidator(0)])),
                ('nomor_PO', models.IntegerField(blank=True, null=True)),
