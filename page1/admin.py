...
admin.site.register(KodePos)
admin.site.register(ItemChangeLog)
admin.site.register(Employee)
admin.site.register(EmployeeAlamat)
admin.site.register(Prospect)
admin.site.register(ProspectTicket)
admin.site.register(TicketLog)
admin.site.register(ProspectPIC)
admin.site.register(ProspectAddress)